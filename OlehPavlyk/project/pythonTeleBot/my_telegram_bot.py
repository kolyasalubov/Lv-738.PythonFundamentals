...
import main
token="5894634062:AAGOvjCBmzl1j6cuyku1zWVasAembH-XkUg"
...
def tele_bot(token):
    ...
    def start_message(message):
        bot.send_message(message.chat.id, f'Hello  {bot.user.username}.\nThis bot is converting pdf file '
                                          f'containing english text.\nJust send pdf file to this chat and'
                                          f'You\'ll get mp3 file.')
