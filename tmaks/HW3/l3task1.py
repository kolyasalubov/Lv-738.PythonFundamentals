...
my_string ='''The Zen of Python, by Tim Peters
...
better = my_string.count("better")
never = my_string.count("never")
count_is = my_string.count("is")
char_upper = my_string.upper() #All characters are upper
print(better, never, count_is)
print(my_string.replace("i", "&")) #All i characters replaced
print(char_upper.replace("I", "&")) #All I characters replaced