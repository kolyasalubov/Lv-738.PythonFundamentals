...
while run:
    ...
    if keys[pygame.K_RIGHT] and COORD_X < (gameDisplay.get_width()-WIDTH_RECTANGLE-DELTA_STEP):
        COORD_X = COORD_X+DELTA_STEP
    if keys[pygame.K_UP] and COORD_Y > DELTA_STEP:
        COORD_Y = COORD_Y-DELTA_STEP
    if keys[pygame.K_DOWN] and COORD_Y < (gameDisplay.get_height()-HEIGHT_RECTANGLE-DELTA_STEP): 
        COORD_Y = COORD_Y+DELTA_STEP
