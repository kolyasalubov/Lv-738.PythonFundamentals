...
# print(zenOfPython.find('better'))

# print(zenOfPython.find('never'))

# print(zenOfPython.find('is'))

# print(zenOfPython.upper())

# print(zenOfPython.replace('i', '&'))

# print(zenOfPython.count('better'))

# print(zenOfPython.count('never'))

print(zenOfPython.count('is'))